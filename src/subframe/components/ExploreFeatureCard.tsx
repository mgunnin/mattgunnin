...
/*
 * Documentation:
 * Explore Feature Card — https://app.subframe.com/3c6d554ad7f3/library?component=Explore+Feature+Card_976ac54f-5cc3-4e1c-ba2c-2b323bcaf846
 */
  ...
  return (
    ...
    >
      <div className="flex h-20 w-20 flex-none items-center justify-center pt-4 pr-4 pb-4 pl-4">
        {image ? (
          <img className="grow shrink-0 basis-0 self-stretch" src={image} />
        ) : null}
      </div>
